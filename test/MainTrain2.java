...
public class MainTrain2 {
	...
	public static void testCacheManager() {
		...
		if(b)
			...
			System.out.println("passed - CacheManager");
		...
		if(!b)
			...
			System.out.println("passed - CacheManager2");
		...
		if(bf || ! bt)
			...
			System.out.println("passed - CacheManager3");
	...
	public static void testBloomFilter() {
		...
		if(!bf.toString().equals("0010010000000000000000000000000000000000000100000000001000000000000000000000010000000001000000000000000100000010100000000010000000000000000000000000000000110000100000000000000000000000000010000000001000000000000000000000000000000000000000000000000000001"))
			...
			System.out.println("passed - bloom filter");
		...
		if(!found)
			...
			System.out.println("passed - bloom filter2");
		found=false;
		for(String w : words) 
			found |= bf.contains(w+"!");
		...
		if(found)
			...
			System.out.println("passed - bloom filter3");
	}
	...
	public static void testDictionary() {
		...
		if(!d.query("is"))
			...
			System.out.println("passed - dictionarry");
		if(!d.challenge("lazy"))
			System.out.println("problem with dictionarry in query (-5)");
		else
			System.out.println("passed - dictionarry2");
	}
